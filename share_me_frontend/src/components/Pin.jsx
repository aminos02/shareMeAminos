            ...
            <div className="flex items-center justify-between">
              <div className="flex gap-2">
                <a
                  ...
                  className="bg-white border-2 border-solid w-9 h-9 rounded-full flex items-center justify-center text-xl text-darl opacity-75 hover:opacity-100 hover:shadow-md outline-none"
                >
